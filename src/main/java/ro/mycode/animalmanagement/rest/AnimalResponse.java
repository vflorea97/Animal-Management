...
public class AnimalResponse {
    ...
    @GetMapping("api/v1/animal/getAllAnimale")
    ...
    @GetMapping("api/v1/animal/getAnimaleOrdonateSpecie")
    ...
    @GetMapping("api/v1/animal/getCelMaiRapidAnimal")
    ...
    @GetMapping("api/v1/animal/getCuloareAnimale")
